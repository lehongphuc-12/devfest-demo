      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between text-center md:text-left">
        ...
        <div className="flex space-x-6">
          <a href="#" className="hover:text-[#10B981] transition-colors">
            <img src="https://picsum.photos/24/24?random=1" alt="Facebook" className="w-6 h-6 rounded-full" />
          </a>
          <a href="#" className="hover:text-[#10B981] transition-colors">
            <img src="https://picsum.photos/24/24?random=2" alt="Twitter" className="w-6 h-6 rounded-full" />
          </a>
          <a href="#" className="hover:text-[#10B981] transition-colors">
            <img src="https://picsum.photos/24/24?random=3" alt="LinkedIn" className="w-6 h-6 rounded-full" />
          </a>
        </div>
      </div>
    </footer>
